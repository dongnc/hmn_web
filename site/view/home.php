...
<div class="searchBox">
  <form id="searchForm" onsubmit="return search()">
    <div class="input-group">
      <select id="selectSearch" class="form-control" placeholder="Type station or line">
        ...
        <option value="line_1" data-alternative-spellings="Ngoc Hoi - Nhu Quynh NH-NQ">1: Ngọc Hồi - Như Quỳnh</option>
        <option value="line_2" data-alternative-spellings="Noi Bai - Nam Thang Long - Thuong Dinh NB-NTL-TD">2: Nội Bài
          - Nam Thăng Long - Thượng Đình
        </option>
        <option value="line_3" data-alternative-spellings="Cat Linh - Ha Dong CL-HD">2A: Cát Linh - Hà Đông</option>
        <option value="line_4" data-alternative-spellings="Troi - Nhon - Yen So T-N-YS">3: Trôi - Nhổn - Yên Sở</option>
        <option value="line_5" data-alternative-spellings="Me Linh - Sai Dong - Lien Ha ML-SD-LH">4: Mê Linh - Sài Đồng
          - Liên Hà
        </option>
        <option value="line_6" data-alternative-spellings="Nam Ho Tay - Hoa Lac - Ba Vi NHT-HL-BV">5: Nam Hồ Tây - Hòa
          Lạc - Ba Vì
        </option>
        <option value="line_7" data-alternative-spellings="Noi Bai - Vinh Quynh NB-VQ">6: Nội Bài - Vĩnh Quỳnh</option>
        <option value="line_8" data-alternative-spellings="Me Linh - Ha Dong ML-HD">7: Mê Linh - Hà Đông</option>
        <option value="line_9" data-alternative-spellings="Son Dong - Mai Dich - Duong Xa SD-MD-DX">8: Sơn Đồng - Mai
          Dịch - Dương Xá
        </option>
  ...
  <form id="naviForm" style="display: none" onsubmit="return naviInput()">
    <div class="selectInput">
      <div class="selectStartLocationContainer">
        <select id="selectStartLocation" class="form-control" placeholder="Type your start location">
          <option value=""></option>
          <option value="station_170" data-alternative-spellings="An Tho AT">An Thọ</option>
          <option value="station_152" data-alternative-spellings="Ba La BL">Ba La</option>
          <option value="station_129" data-alternative-spellings="Ba vi Bv">Ba vì</option>
      ...
      <div class="selectDestinationContainer">
        <select id="selectDestination" class="form-control" placeholder="Type your destination">
        <option value=""></option>
        <option value="station_170" data-alternative-spellings="An Tho AT">An Thọ</option>
        <option value="station_152" data-alternative-spellings="Ba La BL">Ba La</option>
        <option value="station_129" data-alternative-spellings="Ba vi Bv">Ba vì</option>
    ...
    <button type="button" id="closeNaviBtn" class="btn" onclick="changeState()"><span class="fa fa-times"></span>
    </button>
